...
💖Welcome to use the X-UI panel Telegram Bot! please send /help to see what can I do`
        case "author":
            msg.Text = `
👦🏻 Author  : Samuel Ogbeh
📍 Github   : https://github.com/ogbeh
📞 Telegram: @zero_44 (Contact for any issues. Please be patient. As I am a student, I may not be able to reply immediately.)
📧 Email   : sogbeh@gmail.com
            `
		default:
